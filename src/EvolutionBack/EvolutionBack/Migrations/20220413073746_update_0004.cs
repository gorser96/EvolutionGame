    ...
    public partial class update_0004 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InGameUsers_UserId",
                table: "InGameUsers",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Animals_InGameUserUserId_InGameUserRoomUid",
                table: "Animals",
                columns: new[] { "InGameUserUserId", "InGameUserRoomUid" });
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Animals_InGameUsers_InGameUserUserId_InGameUserRoomUid",
                table: "Animals",
                columns: new[] { "InGameUserUserId", "InGameUserRoomUid" },
                principalTable: "InGameUsers",
                principalColumns: new[] { "UserId", "RoomUid" });

            migrationBuilder.AddForeignKey(
                name: "FK_InGameUsers_AspNetUsers_UserId",
                table: "InGameUsers",
                column: "UserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
